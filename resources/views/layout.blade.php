...
<div class="sidebar-contact wrapper-contact-form contact-form">
    ...
    <form action="https://xyz.us7.list-manage.com/subscribe/post?u=adf6e7f3c44e23904d10b6ab5&amp;id=6034d4fdd1" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    ...
    <div class="mc-field-group">
        <label for="mce-NAME">Họ tên </label>
    ...
    <script type='text/javascript' src='//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js'></script><script type='text/javascript'>(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='NAME';ftypes[1]='text';fnames[4]='PHONE';ftypes[4]='phone'; /*
