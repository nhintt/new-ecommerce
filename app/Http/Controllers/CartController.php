...
class CartController extends Controller
{
    ...
    public function gio_hang(Request $request){
        ...
        return view('pages.cart.cart_ajax')->with('cate_product',$cate_product)->with('brand_product',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('getslider',$getslider)->with('getvideo',$getvideo);
    }
            ...
            foreach($data['cart_qty'] as $key => $qty){
                ...
                foreach($cart as $session => $val){
                    ...
                    if($val['session_id']==$key && $qty<$cart[$session]['product_quantity']){
                        ...
                        $message.='<p style="color:blue"> Cập nhật số lượng thành công</p>';

                    }elseif($val['session_id']==$key && $qty>$cart[$session]['product_quantity']){
                        $message.='<p style="color:red"> Cập nhật số lượng thất bại</p>';
                    }
